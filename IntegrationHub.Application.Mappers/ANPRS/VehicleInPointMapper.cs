...
{
    /// <summary>
    /// Mapuje wiersz/odpowiedŸ typu <see cref="VehiclesInPointResponse"/> na <see cref="VehicleInPointDto"/>.
    /// U¿ywa pomocniczych metod z <c>MapperHelpers</c> (Index, FirstIndex, Get, ParseDecimalNullable, Normalize).
    /// </summary>
    internal static class VehicleInPointMapper
    {
        /// <summary>
        /// Mapuje ca³¹ odpowiedŸ gridow¹ na kolekcjê DTO.
        /// Zwraca pust¹ kolekcjê, gdy dane s¹ puste.
        /// </summary>
        ...
        private static VehicleInPointDto? MapRow(IReadOnlyList<string>? row, Dictionary<string, int> index)
        {
            ...
            // Candidate keys - uwzglêdniamy polskie i angielskie warianty oraz skróty
            ...
            // Latitude / Longitude: u¿yj ParseDecimalNullable z MapperHelpers, konwertuj do double
