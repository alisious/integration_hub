...
{
    public class ValidateCsvDischargedListActionConfig : PluginConfiguration
    {
        [ConfigGroupBox(DisplayName = "Zakres walidacji listy", Order = 1)]
        public CsvDichargedValidationConditions ValidationConditionsGroupBox { get; set; }
    ...
    public class CsvDichargedValidationConditions : ValidationConditions
    {
